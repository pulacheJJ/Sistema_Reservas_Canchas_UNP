<div id="modal-reserva" class="hidden fixed inset-0 bg-black/60 flex items-center justify-center z-50 transition-opacity p-4">
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-5xl p-6 transform transition-all scale-95 max-h-[90vh] overflow-y-auto" id="modal-content">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="border-r pr-4 hidden md:block">
                ...
                <form action="{{ route('reservas.store') }}" method="POST" id="form-reserva" class="space-y-4">
                    ...
                    @if(Auth::user()->isAdmin())
                        <div class="bg-purple-50 p-4 rounded-lg border border-purple-200 mb-4 shadow-sm">
                            ...
                            <input type="text" id="codigo_estudiante" name="codigo_estudiante" placeholder="Código Universitario del Alumno" 
                                ...
                                title="Si ingresas un código, la reserva y el mensaje de WhatsApp le llegarán a ese alumno.">
