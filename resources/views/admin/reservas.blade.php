                                ...
                                @else
                                    <div class="flex gap-2 items-center">
                                        @if($reserva->estado === 'Aprobada')
                                            <a href="{{ asset('storage/tickets/ticket_reserva_' . $reserva->id . '.pdf') }}" target="_blank" class="flex items-center gap-1 bg-blue-50 text-blue-700 hover:bg-blue-100 border border-blue-200 px-3 py-1.5 rounded-lg transition-all shadow-sm text-xs font-semibold">
